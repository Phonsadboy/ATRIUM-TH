...
def chat_tool_system_instructions(departments: list[dict[str, Any]], active_dept: dict[str, Any]) -> str:
    ...
    tool_policy = (
        ...
        "For motion-graphics packages, call video.render_motion with renderer='remotion', 'revideo', 'hyperframes', 'both', or 'all'; HyperFrames writes an HTML-first video project with index.html/DESIGN.md and lint/inspect/preview/render commands, and can render automatically through npx hyperframes when the CLI is installed or allowInstall=true. "
