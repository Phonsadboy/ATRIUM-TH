...
MIN_REVIEW_INTERVAL_MS = 10 * 60_000
MAX_REVIEW_INTERVAL_MS = 7 * 24 * 60 * 60_000
DEFAULT_REVIEW_INTERVAL_MS = 10 * 60_000
RECOMMENDED_REVIEW_INTERVAL_BY_PRIORITY_MS = {
    "urgent": DEFAULT_REVIEW_INTERVAL_MS,
    "high": DEFAULT_REVIEW_INTERVAL_MS,
    "normal": DEFAULT_REVIEW_INTERVAL_MS,
    "low": DEFAULT_REVIEW_INTERVAL_MS,
}
